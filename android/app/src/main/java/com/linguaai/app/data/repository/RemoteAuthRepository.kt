...
class RemoteAuthRepository @Inject constructor(
    ...
    suspend fun updateProfile(request: UpdateProfileRequestDto): AppResult<ProfileData> =
        mapProfile { authApi.updateProfile(request) }

    suspend fun fetchProfile(): AppResult<ProfileData> =
        mapProfile { authApi.profile() }
    ...
    private suspend fun persistSession(user: com.linguaai.app.data.remote.dto.UserDto, accessToken: String, refreshToken: String) {
