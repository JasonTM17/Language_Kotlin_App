    ...
    companion object {
        fun fromEnv(env: (String) -> String? = System::getenv): AppConfig {
            ...
            return AppConfig(
                ...
                dbUrl = str(
                    "DB_URL",
                    "jdbc:mysql://${str("DB_HOST", "localhost")}:${int("DB_PORT", 3306)}/" +
                ...
                accessTokenTtlMinutes = long("JWT_ACCESS_TOKEN_EXPIRY_MINUTES", 30L),
                refreshTokenTtlDays = long("JWT_REFRESH_TOKEN_EXPIRY_DAYS", 14L),
