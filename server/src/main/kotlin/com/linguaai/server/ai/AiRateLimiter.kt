 ...
 */
class AiRateLimiter(private val maxRequestsPerMinute: Int) {

    private data class Window(val hits: Deque<Instant> = ConcurrentLinkedDeque())
    ...
    fun tryAcquire(userId: Long, now: Instant = Instant.now()): Boolean {
